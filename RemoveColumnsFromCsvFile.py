...
PATH = 'D:\\temp\\test\\'
FILENAME_IN = 'file.csv'
REMOVE_COLUMNS = ['columNameA','columNameB']


def main():
    csvFileIn = PATH + FILENAME_IN
    ...
    filenameOut = FILENAME_IN.split('.')[0] + '_OUT.' + FILENAME_IN.split('.')[1]
    csvFileOut = PATH + filenameOut
